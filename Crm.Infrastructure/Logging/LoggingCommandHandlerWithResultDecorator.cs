...
{
    internal class LoggingCommandHandlerWithResultDecorator<T, TResult> : IRequestHandler<T, TResult> where T : ICommand<TResult>
    {
        ...
        public async Task<TResult> Handle(T command, CancellationToken cancellationToken)
        {
            ...
            using (
                LogContext.Push(new RequestLogEnricher(_executionContextAccessor),new CommandLogEnricher(command)))
            {
                try
                {
